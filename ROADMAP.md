...
- [ ] Настроить первые 2 минуты spawn curve.
- [ ] Добавить Grave Rat в игровой спавн.
- [ ] Добавить Rot Walker в игровой спавн.
- [ ] Добавить простую separation-логику врагов.
- [ ] Добавить hit flash, death burst и pickup burst.
- [ ] Довести первый level-up до 30-60 секунд у среднего игрока.
- [ ] Добавить читаемые weapon icons в HUD.
- [ ] Добавить первый балансный проход по HP, урону и XP.
